...
## What is the daily mean total number of steps taken?
...
qplot(total.steps,
      ...
      ylab="Frequency",
      main="Histogram: Total number of steps taken daily" )
```
...
qplot(imputed.total.steps,
      xlab="Total steps",
      ylab="Frequency",
      main="Histogram : Total number of steps taken each day in imputed dataset")
```
...
The above result show thatimputing the missing data has increased the average number of steps.
